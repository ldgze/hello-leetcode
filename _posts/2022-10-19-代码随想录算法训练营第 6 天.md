...
2. ##### With the help of [ConcurretHashMap](https://www.geeksforgeeks.org/concurrenthashmap-in-java/)(Similar to Hashtable, Synchronized, but faster as multiple locks are used)

3. ##### With the help of [HashSet](https://www.geeksforgeeks.org/hashset-in-java/) (Similar to HashMap, but maintains only keys, not pair)

4. ##### With the help of [LinkedHashSet](https://www.geeksforgeeks.org/linkedhashset-class-in-java-with-examples/) (Similar to LinkedHashMap, but maintains only keys, not pair)
