...
>
> If we say that `c` is the *shared* part, aaa is *exclusive part of list A* and bbb is *exclusive part of list B*, then we can have one pointer that goes over `a + c + b` and the other that goes over `b + c + a`. Have a look at the diagram below, and this should be fairly intuitive.
>
> ![](../assets/imgs/V0PuRwP.png)
>
